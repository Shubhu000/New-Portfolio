...
export default function Navbar(): JSX.Element {
  ...
  return (
    <>
      ...
      >
        {/* <Banner /> */}
        <div className="flex flex-row items-center justify-between safe-x-padding">
          <Link className="z-50" href="/" onClick={closeMenu} prefetch={false}>
            <div className="w-[90px] h-[91px] lg:w-[100px] lg:h-[101px]">
              <BrandIcon />
            </div>
          </Link>
          {/* desktop menu */}
          <div className="flex-row items-center justify-between hidden text-lg font-bold md:flex md:gap-6 lg:gap-8">
            ...
            <a
              ...
              href="https://drive.google.com/file/d/1Ecj48kq1PH80ZGgcbbj_gf3IeZLyYCkn/view?usp=sharing"
