      ...
      <div className="grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0">
        ...
        <div className="flex flex-col items-center justify-center order-2 xl:items-start xl:order-1">
          ...
          <motion.p
            ...
            aria-label="I'm Shubham Damania. A passionate Full Stack Developer based in India."
          >
            I&apos;m Shubham Damania. A passionate Full Stack Developer based in
            India.
          </motion.p>
        </div>
        {/* second */}
