...
export default function SectionLetsConnect() {
  ...
  const socialMediaLinks = [
    ...
    },
    {
      ...
      tabIndex: 0,
      onClick: () =>
        window.open('https://www.instagram.com/shubham_damania0', '_blank'),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
      ...
      height: 168,
      tabIndex: 0,
      onClick: () => window.open('https://github.com/Shubhu000', '_blank'),
    },
    {
      initial: { y: -50, opacity: 0 },
      animate: inView ? { y: 0, opacity: 1 } : {},
      ...
      height: 168,
      tabIndex: 0,
      onClick: () => window.open('https://x.com/DamaniaShubham', '_blank'),
    },
    {
